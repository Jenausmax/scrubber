...
- **D-02:** Универсальный/настраиваемый формат отвергнут: REQUIREMENTS §Out of Scope запрещает встроенный плеер и редактирование транскрипта, повторных потребителей аудио в v1 нет.
...
- **D-13:** **Авто-очистка кеша в Phase 2 не делается.** Phase 5 / отдельная backlog-задача добавит кнопку «Очистить кеш извлечённого аудио» в Settings и/или TTL-политику.
