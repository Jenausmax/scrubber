...
const REASON_COPY: Record<MediaReason, string> = {
  invalid_argument: 'Можно перетащить только один файл за раз.',
  ...
  ffmpeg_failed:
    'Не удалось извлечь аудио. Файл повреждён или неподдерживаемый кодек.',
  cancelled: 'Извлечение отменено',
  disk_full:
    'Недостаточно места на диске для извлечения аудио. Освободите место и попробуйте снова.',
